...
function operationFromDocument(schema, document, options) {
    ...
    fragments.validate();
    return operationFromAST({ schema, operation, fragments, validateInput: options === null || options === void 0 ? void 0 : options.validate });
}
exports.operationFromDocument = operationFromDocument;
function operationFromAST({ schema, operation, fragments, validateInput, }) {
    var _a;
